...
const allowedThemeHexes = new Set([
  // Pewter Sage palette — see _shared/design/theme_tokens.json
  // and the source design canvas (color-themes.jsx `pewterSage`).
  '#7ec096',
  '#a8d4ba',
  '#9cc5ac',
  '#b5d4c2',
...
const expectedWaveRibbonColors = {
  ...
  ribbonALightEnd: '#d8dadf',
  ribbonBLightStart: '#c8ccd2',
  ribbonBLightEnd: '#c8ccd2',
  ribbonCLightStart: '#bcc0c7',
  ribbonCLightEnd: '#bcc0c7',
  ribbonADarkStart: '#343842',
  ribbonADarkEnd: '#343842',
  ribbonBDarkStart: '#4a4f59',
  ribbonBDarkEnd: '#4a4f59',
  ribbonCDarkStart: '#23272e',
  ribbonCDarkEnd: '#23272e',
};
