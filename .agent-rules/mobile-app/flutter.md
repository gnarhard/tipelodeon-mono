...
* **Presentation boundaries:** In this repo, `presentation/` code must not
  import from `data/` or `core/outbox/`. Put repository-backed, sync, upload,
  and cross-feature orchestration logic behind controller or domain APIs.
